...
| 01.07 | in_review | [Draft PR #21](https://github.com/cuneytbozok/finpill/pull/21) contains shared native link handling and Vercel-host associations. Code and native builds passed; deployed association and signed-device acceptance remain. See handoff. |
