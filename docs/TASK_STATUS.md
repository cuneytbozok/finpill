...
- Publication: PR #11 remains draft pending that result. This handoff and the safe-area fix are included in the next branch commit. Once the iOS offline result is recorded, finish 01.02 acceptance and review handoff; do not start another task in this session. No architecture gate is accepted, and 01.08’s broader native design-system acceptance is not claimed complete.
