...
| 01.07 | in_review | Shared native link handling and Vercel-host associations implemented on `codex/01.07-deep-links`. Code and native builds passed; deployed association and signed-device acceptance remain. See handoff. |
...
- Owner: Codex; branch `codex/01.07-deep-links`, isolated worktree `.worktrees/01.07`, base `35b1a12` from `origin/main`.
