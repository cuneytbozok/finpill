...
| 01.09 | in_progress | Branch `codex/01.09-deployment-foundation` from `c26804d`; local checks passed and separate Vercel API project exists. Hosted Preview and isolation proof remain. See handoff. |
| 01.10 | pending | — |
