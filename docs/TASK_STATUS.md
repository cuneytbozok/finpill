...
- Publication: documentation commit and PR to be recorded after checks. This revision must merge into origin/main before it becomes canonical task-discovery input.
