...
- Approval boundary: automatic approval review rejected saving provisional API Production settings because pilot resources and production origins have not been verified. The unsaved changes were discarded. Do not retry or route around that decision; verify the prerequisites and obtain approval before configuring Production.
