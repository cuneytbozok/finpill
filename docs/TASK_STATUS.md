...
| 01.06 | in_review | [Draft PR #20](https://github.com/cuneytbozok/finpill/pull/20): Clerk/Supabase staging trust, profiles, eligibility and RLS implemented. Staging SQL and negative Data API checks passed; eligible-account live acceptance remains. See handoff. |
| 01.07 | pending | — |
